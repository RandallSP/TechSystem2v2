...
-- Fecha: 2026
--
-- COMO USARLO (en este orden):
-- 1. Ejecute ESTE script para crear la base de datos y las 6 tablas
--    con sus datos de prueba.
-- 2. Ejecute ProcedimientosAlmacenados.sql para crear los
--    procedimientos almacenados que usa el sistema.
--
-- USUARIO DE PRUEBA:
-- Correo: randall@uhispano.ac.cr   Clave: 123
-- (las claves se guardan encriptadas con SHA256, ocupan 64 caracteres)
-- =============================================
